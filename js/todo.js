...
function addTodo(value) {
	...
	todoItemContainer.classList.add('todo-item-value-container');
	todoItemContainer.appendChild(checkboxDone); 
	todoItemContainer.appendChild(text);

	let todoEditIconsContainer = document.createElement('div');
	todoEditIconsContainer.classList.add('todo-edit-icons-container');
	todoEditIconsContainer.appendChild(editIcon); 
	todoEditIconsContainer.appendChild(deleteIcon);

	li.appendChild(todoItemContainer);
	li.appendChild(todoEditIconsContainer);
	todoList.append(li);
	todoInput.value = '';
}
